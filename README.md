...
### 1 Прототипы микросрвисов
- api (общие типы и интерфейсы)
- процессинг данных
  - получение данных со стороннего api
  - процессинг данных
- тестовые хранилища данны: пустое, заполненное, с ошибкой
- http эндпоинт
- grpc эндпоинт
  - сервер
  - тестовый клиент
...
- клиент базы данных (LedisDB)
- grpc клиент реализующий storage
- grpc сервис доступа к данным
- ручное интеграционное тестирование
- Makefile, конфигурационные переменные
- Readme

### 3 Рефакторинг и улучшение функционала
- запрос url с помощью gorilla
- перенос схем и автогенерации proto в разные папки
- вынос id приложения и страны в конфигурацию менеджера
- TODO: openapiv2 swagger
- TODO: grphql
